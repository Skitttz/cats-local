...
function api_password_lost($request){
  ...
  $message = "Utilize o link abaixo para redefinir sua senha: \r\n";
...
function register_api_password_lost(){
  register_rest_route('api','/password/lost',['methods' => WP_REST_Server::CREATABLE,'callback' => 'api_password_lost']);
}
...
function register_api_password_reset(){
  register_rest_route('api','/password/reset',['methods' => WP_REST_Server::CREATABLE,'callback' => 'api_password_reset']);
}
